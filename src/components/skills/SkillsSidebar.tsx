...
export function SkillsSidebar({ jobData, setJobData }: SkillsSidebarProps) {
  ...
  return (
    <div className="bg-white/90 backdrop-blur-sm rounded-2xl shadow-lg border border-slate-200 p-6 h-full flex flex-col overflow-hidden">
      <h2 className="text-xl font-bold text-slate-800 mb-4 shrink-0">Extracted Skills</h2>
